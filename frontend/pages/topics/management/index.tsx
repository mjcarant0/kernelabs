/* Memory Management Topic - Main Page */
...
import { memoryManagementConfig } from "./topicMeta";
import { quizQuestions } from "./quiz/quizData";
import { module5Sections } from "./modules/Module5";

type PageSection = "modules" | "quiz";

export default function MemoryManagementTopic() {
      ...
      <div className="relative z-10">
          ...
          <div className="max-w-6xl mx-auto px-6 py-16">
            <div className="space-y-4">
              ...
              <h1 className="text-5xl md:text-6xl font-bold text-(--text-primary) leading-tight">
                {memoryManagementConfig.name}
              </h1>
              <p className="text-lg text-(--text-secondary) max-w-3xl leading-relaxed">
                {memoryManagementConfig.description}
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto px-6 py-12">
          {currentSection === "modules" ? (
            <ModuleSection
              title={memoryManagementConfig.name}
              content=""
