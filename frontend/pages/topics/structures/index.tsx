...
import { structuresConfig } from "./topicMeta";
import { quizQuestions } from "./quiz/quizData";
import { module2Sections } from "./modules/Module2";

type PageSection = "modules" | "quiz";

export default function StructuresTopic() {
          ...
          <div className="max-w-6xl mx-auto px-6 py-16">
            <div className="space-y-4">
              ...
              <h1 className="text-5xl md:text-6xl font-bold text-(--text-primary) leading-tight">
                {structuresConfig.name}
              </h1>
              <p className="text-lg text-(--text-secondary) max-w-3xl leading-relaxed">
                {structuresConfig.description}
              </p>
            </div>
          </div>
        </div>
