...
const devs = [
  {
    ...
    intro: "Architected and built the core platform — bridging frontend, backend, and CI/CD pipelines to power the full Kernelabs simulation engine.",
    accent: "cyan" as const,
    image: "/images/dev-mj.jpg",
